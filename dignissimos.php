...
<head>
    ...
    <title>Dignissimos - 7/11 (Napoles, John M. 4L)</title>
...
<body>
    ...
    <div class="homeSection">
        <div class="titleSection">
            <h1 class="titleTitle"><?php echo $headermenu3; ?></h1>
    ...
    <script>
        ...
        function headerLinkActive () {
            headerLinkHover1.setAttribute("class","headerLinkHover")
            headerLinkHover2.setAttribute("class","headerLinkHover")
            headerLinkHover3.setAttribute("class","headerLinkHover headerLinkActive")
