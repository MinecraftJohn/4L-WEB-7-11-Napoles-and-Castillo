...
<head>
    ...
    <title>Blanditiis - 7 Eleven (Napoles, John M. 4L)</title>
...
<body>
    ...
    <div class="homeSection">
        <div class="titleSection">
            <h1 class="titleTitle"><?php echo $headerMenu[3]; ?></h1>
    ...
    <script>
        ...
        function headerLinkActive () {
            ...
            headerLinkHover[3].setAttribute("class","headerLinkHover headerLinkActive")
        }
        headerLinkActive ()
    </script>
</body>
